        ...
        while (true) {
            ...
            if (action.equals("buy")) { 
                ...
                if (choice.equals("1")) {
                    ...
                    if (waterQuantity >= waterQuantityNeeded && milkQuantity >= milkNeeded && coffeeBeansQuantity >= coffeeBeansNeeded && cupsDisposable >= cupsUsed) {
                        ...
                        if (milkNeeded > milkQuantity) {
                            System.out.println("Sorry, not enough milk!");
                        }
                        if (coffeeBeansNeeded > coffeeBeansQuantity) {
                            System.out.println("Sorry, not enough coffee!");
                        }
                        if (cupsUsed > cupsDisposable) {
